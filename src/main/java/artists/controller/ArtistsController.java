...
public class ArtistsController {
	...
	public ArtistsAlbum retrieveAlbumById(@PathVariable Long artistsId, 
			@PathVariable Long albumId) {
		
		log.info("Retrieving album with ID={}", albumId, 
			" from artist with ID={}", artistsId);
		return artistsService.retrieveAlbumById(artistsId, albumId);
	}
	
	@GetMapping("/artists/{artistsId}/album/{albumId}/song/{songId}")
	public ArtistsSong retrieveSongById(@PathVariable Long artistsId,
			@PathVariable Long albumId, @PathVariable Long songId) {
		
		log.info("Retrieving song with ID={}", songId, 
			" from the album with ID={}", albumId,
	...
	public ArtistsMember retrieveMemberById(@PathVariable Long artistsId,
			@PathVariable Long memberId) {
		log.info("Retrieving member with ID={}", memberId,
			" from the artist with ID={}", artistsId);
	...
	public ArtistsInstrument retrieveInstrumentById(@PathVariable Long artistsId, 
			@PathVariable Long memberId, @PathVariable Long instrumentId) {
		
		log.info("Retrieving instrument with ID={}", instrumentId,
			" that is used by the member with ID={}", memberId,
	...
	@ResponseStatus(code = HttpStatus.CREATED)
	public ArtistsSong addSong(@PathVariable Long artistsId,
			@PathVariable Long albumId, @RequestBody ArtistsSong artistsSong) {
	...
	public ArtistsAlbum updateAlbum(@PathVariable Long artistsId, @PathVariable Long albumId, @RequestBody ArtistsAlbum artistsAlbum) {
	...
	public ArtistsSong updateSong(@PathVariable Long artistsId, @PathVariable Long albumId, @PathVariable Long songId, @RequestBody ArtistsSong artistsSong) {
	...
	public ArtistsMember updateMember(@PathVariable Long artistsId, @PathVariable Long memberId, @RequestBody ArtistsMember artistsMember) {
	...
	public ArtistsInstrument artistsInstrument(@PathVariable Long artistsId, @PathVariable Long memberId, @PathVariable Long instrumentId, @RequestBody ArtistsInstrument artistsInstrument) {
	...
	public Map<String, String> deleteSongById(@PathVariable Long artistsId, @PathVariable Long albumId, @PathVariable Long songId) {
	...
	public Map<String, String> deleteInstrumentById(@PathVariable Long artistsId, @PathVariable Long memberId, @PathVariable Long instrumentId) {
